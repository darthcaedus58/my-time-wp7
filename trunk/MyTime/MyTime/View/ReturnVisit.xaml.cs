...
namespace FieldService.View
{
    ...
    public partial class ReturnVisitPage : PhoneApplicationPage
    {
        ...
        private void bAddVisit_Click(object sender, RoutedEventArgs e)
        {
            ...
            NavigationService.Navigate(new Uri(String.Format("/View/PreviousCall.xaml?rvid={0}", _currentReturnVisitData == null ? "-1" : _currentReturnVisitData.ItemId.ToString(CultureInfo.InvariantCulture)), UriKind.Relative));
        }
